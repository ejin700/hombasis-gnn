...
1. The subdirectory `brec` is a partial clone of [https://github.com/GraphPKU/BREC/tree/966b5ed5c27bf6372ea081f90ef8c8b2a3342ebc](BREC) by [Wang & Zhang (2023)](https://arxiv.org/abs/2304.07702). This project can be used to reproduce the BREC experiements from Section 5.4 of the paper. 
...
4. The subdirectory `qm9` is a modified clone of [https://github.com/radoslav11/SP-MPNN/tree/main](SP-MPNN) by [Abboud et al. (2022)](https://arxiv.org/abs/2206.01003). This project can be used to reproduce the QM9 experiments from Section 5.2 of the paper.
5. The subdirectory `zinc-baseplane` is a modified clone of [https://github.com/ZZYSonny/PlanE/tree/ce2561bfae46248c3260ac91b4a59be5d0d1c9a1](PlanE) by [Dimitrov et al. (2023)](https://arxiv.org/abs/2307.01180). This project can be used to reproduce the BasePlanE experiments on ZINC from Section 5.1 of the paper.
