...
def fn_get_dataset():
    ...
    return get_dataset(
        name=arg.dataset, split=arg.cur_split, fn_final_transform=process, count_type=arg.count_type
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--count_type", type=str)
    parser.add_argument("--count_dim", type=int)
