...
def get_dataset(
    name: str, fn_final_transform=None, split: str = "", tag: str = "v0", count_type: str = "",
):
    ...
    match name:
        ...
        case "HombasisZINC12kNoE":
            from datasets.zinc import ZINCDataset

            fn_dataset = lambda split: ZINCDataset(
                root=root,
                subset=True,
                split=split,
                pre_transform=pre_transform,
