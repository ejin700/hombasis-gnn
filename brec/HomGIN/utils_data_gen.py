...
#                      num_processes=1,
#                      **subgraph_params):
def generate_dataset(data_path, dataset_name, extract_ids_fn, regression):
    ...
    elif dataset_name in ['brec_4vtx', 'brec_dr', 'brec_cfi', 'brec_v3', 'brec_v3_s4', 'sr16622', 'sr251256', 'sr261034', 'sr281264', 'sr291467', 'sr351668', 'sr351899', 'sr361446', 'sr401224']:
    ...
    # else:
    homcount_file = os.path.join(data_path, f'{dataset_name}_v5_counts.json')
    ...
    # for data in tqdm(graphs):
        homcount_dict = homcount_data[str(i)]['homcounts']
        new_data = _prepare(data, homcount_dict, regression, dataset_name, extract_ids_fn)
...
def _prepare(data, homcount_dict, regression, dataset_name, ex_fn):
    ...
    # else:
    new_data = ex_fn(new_data, homcount_dict)
